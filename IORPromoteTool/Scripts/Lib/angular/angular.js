...
function $CompileProvider($provide, $$sanitizeUriProvider) {
  ...
  this.$get = [
    ...
    /**
     * Given a node with an directive-start it 'inputType': inputType // LF Helen: added this to use it outside of angular.collects all of the siblings until it finds
     * directive-end.
     * @param node
     * @param attrStart
     * @param attrEnd
